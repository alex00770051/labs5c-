...
void SetRussianLocale() {
    system("chcp 65001 > nul");  // Устанавливаем кодовую страницу UTF-8
...
void ShowMenu() {
    ...
    cout << "3. Работа с текстовыми данными - по одному числу в строке (Задание 4)" << endl;
    cout << "4. Работа с текстовыми данными - несколько чисел в строке (Задание 5)" << endl;
...
void TextFileMultipleMenu() {
    ...
    while (true) {
        cout << "\n=== МЕНЮ ТЕКСТОВЫХ ДАННЫХ (несколько чисел в строке) ===" << endl;
        cout << "1. Заполнить файл случайными числами" << endl;
        cout << "2. Показать содержимое файла" << endl;
...
void TextFileStringsMenu() {
    ...
    while (true) {
        ...
        cout << "2. Показать содержимое файла" << endl;
        cout << "3. Задание 6 - копировать строки, оканчивающиеся на символ" << endl;
        cout << "4. Создать тестовый файл" << endl;
        cout << "0. Назад" << endl;
        cout << "Выбор: ";
